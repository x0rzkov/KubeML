...
const HomePage = () => (
  <Container fluid>
    <Row style={{ backgroundColor: "#1a75ff" }}>
      <Row className="inner-row p-row-2">
        <Col style={{ alignItems: "center", height: 300 }}>
    ...
    <Row style={{ backgroundColor: "#e8e8e8" }}>
      <Row className="inner-row py-row-4">
